...
const navigationMenuTriggerStyle = cva(
  "inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors focus:outline-none disabled:opacity-50 focus:bg-white disabled:pointer-events-none bg-transparent hover:bg-white text-white hover:text-black data-[state=open]:bg-white data-[state=open]:text-black data-[active]:bg-white h-10 py-2 px-4 group w-max"
);
...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Indicator
    ...
    {...props}
  >
    <div className="relative top-[60%] h-2 w-2 rotate-45 rounded-tl-sm bg-slate-200 shadow-md dark:bg-white" />
  </NavigationMenuPrimitive.Indicator>
));
