    ...
    <div className="w-fit h-fit mr-1 relative">
      ...
      >
        ...
        <input
          ...
          className="w-full text-base will-change-transform pr-2 overflow-hidden h-10 bg-transparent outline-hidden ml-8 leading-none placeholder:leading-none text-black"
        />
      </div>
    </div>
  )
